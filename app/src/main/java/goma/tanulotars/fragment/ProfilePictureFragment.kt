...
class ProfilePictureFragment(val user: User) : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        user.profilePicture = resources.getDrawable(R.drawable.avatar1, context!!.theme)
    }
    ...
    private fun changeProfilePicture(imageRes: String) {
        ...
        user.profilePicture = resources.getDrawable(res, context!!.theme)
    }
